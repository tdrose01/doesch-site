    ...
    <main>
      <section className="relative flex min-h-[calc(100vh-72px)] items-end overflow-hidden px-6 py-14 md:px-10">
        ...
        >
          ...
          <p className="mb-4 font-display text-xl text-gold tracking-wide">Engineered Elegance.</p>
          <h1 className="max-w-3xl font-display text-5xl leading-[0.95] text-zinc-100 drop-shadow-[0_0_30px_rgba(127,90,166,0.5)] md:text-8xl">
            Objects of Desire,
            <span className="block text-gold">Crafted for Legacy.</span>
          </h1>
